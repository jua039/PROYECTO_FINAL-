(function () {
  ...
  window.actualizarContadorCarrito = function actualizarContadorCarrito() {
    ...
    document.querySelectorAll("#contadorCarrito, #contadorCarritoFlotante").forEach((el) => { el.textContent = cantidad; });
